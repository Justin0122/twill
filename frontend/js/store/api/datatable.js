...
export default {
   ...
   */
  get(params, callback) {
    axios.get(window[process.env.VUE_APP_NAME].CMS_URLS.index, { params }).then(
      function(resp) {
  ...
  reorder(ids, callback) {
    axios.post(window[process.env.VUE_APP_NAME].CMS_URLS.reorder, { ids }).then(
      function(resp) {
        if (callback && typeof callback === 'function') callback(resp)
      },
      function(resp) {
  ...
  bulkDelete(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkDelete, { ids })
      .then(
        function(resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  bulkRestore(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkRestore, { ids })
      .then(
        function(resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
  ...
  bulkDestroy(ids, callback) {
    axios
      .post(window[process.env.VUE_APP_NAME].CMS_URLS.bulkForceDelete, { ids })
      .then(
        function(resp) {
          if (callback && typeof callback === 'function') callback(resp)
        },
